...
# chi3d
```bash
python -m tridi.preprocessing.preprocess_chi3d -c ./config/env.yaml -- chi3d.split="train" chi3d.root="/home/cc/Documents/datasets/chi3d/raw" chi3d.downsample="10fps"
python -m tridi.preprocessing.preprocess_chi3d -c ./config/env.yaml -- chi3d.split="test" chi3d.root="/home/cc/Documents/datasets/chi3d/raw" chi3d.downsample="10fps"
```